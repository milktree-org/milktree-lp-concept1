...
export const workProjects: WorkProject[] = [
  ...
  },
  {
    ...
    challenge:
      "A charity dinner has one night to justify a year of asking. The invitation, the stairs on the way in, the programme at the place setting and the auction card that opens wallets all have to feel like one considered occasion, not a stack of separate print jobs. And it all had to sit respectfully alongside Southampton FC's crest and a wall of event partners without turning into a logo soup.",
    approach:
      "We built a sharp event identity around the club's black and red: a signature radiating-lines motif, condensed display type and a strict layout system with a clean partner band. Then we rolled it across everything the night needed, from main-stage and screen graphics to spiral-bound programmes, auction collateral, welcome cards, raffle packs, stair graphics and the media wall. A guest met the same brand from the car park to the last lot of the auction.",
    outcome:
  ...
  },
  {
    ...
    challenge:
      "Zillwoods' clients commission joinery precisely because they notice details most people miss. The old brand didn't survive that level of scrutiny. For a craft business, a brand that's less considered than the work quietly tells customers the standard is negotiable.",
    approach:
  ...
  },
  {
    ...
    approach:
      "We stripped everything back to industrial fundamentals: a hard-edged mark, utilitarian type and a restrained palette that borrows its confidence from engineering rather than marketing. Then we applied it with precision across the touchpoints that matter in this sector, from stationery and tender print to posters and site collateral, where consistency itself signals operational discipline.",
    outcome:
  ...
  },
  {
    ...
    intro:
      "EJW pours the foundations other trades build on. The campaign leaned into that permanence: heavyweight type, honest photography and a line that does what concrete does. It holds.",
    seoDescription:
    ...
    challenge:
      "Concrete is the least glamorous trade on any site and the one everything else depends on. EJW's work was literally foundational, but its marketing was invisible. In a sector where reputation travels by word of mouth, the company had no creative asset making the case for it at scale.",
    approach:
      "We leaned into what concrete actually means: permanence. Heavyweight typography that feels poured rather than printed, honest photography of real work in real light, and 'built to last' as a campaign line that works as both promise and proof. The creative rolled out across cinema-scale out-of-home, site flags and brand collateral, all carrying the same unshakeable weight.",
    outcome:
  ...
  },
  {
    ...
    challenge:
      "SaleSprout sells growth, the outbound engines that fill B2B pipelines, but its own brand didn't look like it was growing. For a company whose product is confidence, an anonymous visual identity was a credibility gap every prospect could see before the first call.",
    approach:
      "We built a system with the energy of a sales floor on a good month: a fresh palette, an optimistic mark and typography that moves. Then we put it where growth gets noticed. Office signage, rooftop displays and city billboards turned SaleSprout's own premises and skyline presence into the case study it pitches with.",
    outcome:
